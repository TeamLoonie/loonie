...
#ifdef ENABLE_WALLET
        {"loonie", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:80521/\n";
}
