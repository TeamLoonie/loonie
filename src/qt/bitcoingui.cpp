                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Loonie Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        progressBar->setStyleSheet("QProgressBar { background-color: 4CA770; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #00CCFF, stop: 1 #33CCFF); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Loonie Core help message to get a list with possible Loonie command-line options"));
