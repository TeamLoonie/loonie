...
{
    std::string genesisblockhash = "00000944b26677decf813faf1da74f80e48bc37923d151050d6af6eade4dc5ce";
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#138170;}\n a, span { font-family: monospace; }\n span.addr {color:#138170; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #138170;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#138170;}\n a { color:#FFFC00; text-decoration:none; }\n a.nav {color:#138170;}\n";
