...
In order to support loading of multiple wallets in loonie-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is loonie.cpp.
...
Changes to loonie.cpp
----------------------
loonie.cpp is the entry point into loonie-qt, and as such, will require some minor modifications to provide hooks for
