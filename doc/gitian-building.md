...
*Setup instructions for a gitian build of Loonie using a Debian VM or physical system.*
...
- [Building Loonie](#building-loonie)
...
To build Loonie (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/eastcoastcrypto/Loonie
...
For example:
```bash
URL=https://github.com/eastcoastcrypto/Loonie.git
